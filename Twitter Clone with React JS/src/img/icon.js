...
export const PopularIcon = () => {
  return (
    <Svg className="w-7 h-7 text-basis-Blue">
      <g>
...
export const ImageIcon = () => {
  return (
    <Svg className="w-6 h-6 text-basis-Blue">
      <g>
...
export const ReplyIcon = () => {
  return (
    <Svg className="w-5 h-5 text-grayColors-light group-hover:text-basis-Blue">
      <g>
...
export const RtIcon = () => {
  return (
    <Svg className="w-5 h-5 text-grayColors-light group-hover:text-green-400">
      <g>
...
export const FavIcon = () => {
  return (
    <Svg className="w-5 h-5 text-grayColors-light group-hover:text-pink-400">
      <g>
